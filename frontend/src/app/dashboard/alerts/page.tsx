...
function AlertsPage() {
    ...
    const filtered = useMemo(() => {
        ...
        return [...data].sort((a, b) => sort === "newest" ? new Date(b.created_at).getTime() - new Date(a.created_at).getTime() : new Date(a.created_at).getTime() - new Date(b.created_at).getTime())
